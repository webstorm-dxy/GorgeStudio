...
class ReincalRespondHint : Element
{
    float startTime;
    ...
    ReincalRespondHint(Vector2 respondPosition, float startTime, Node reference, ColorArgb color1, ColorArgb color2)
    {
        ...
        transformers[0] = new ReincalRespondHintTransformer(this);
        transformers[1] = new ReincalRespondHintHeartTransformer(this);
        
        // GorgeGraphics
        ImageAsset lineImage = (ImageAsset) Environment.GetAssetByName("image:Reincal/FormAsset/RespondHint");
        ...
        ImageAsset heartImage = (ImageAsset) Environment.GetAssetByName("image:Reincal/FormAsset/Heart");
