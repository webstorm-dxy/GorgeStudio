...
class ReincalSliderHoldTsiga
{
    TimeStack timeStack;
    InputGraph inputGraph;
    HistoryStack historyStack;
    
    ReincalSliderHoldTsiga(ReincalSliderHold note, bool isReverse)
    {
        ...
        delegate<void:Note,TimeStack,float,HistoryStack> pushInnerRespondTimeItem =
            ...
            {
                ReincalSliderHold note = (ReincalSliderHold) holdNote;
        ...
        ReincalSliderLane lane = note.lane;
        ...
        InputGraphState state1 = new InputGraphState(
            new FloatSignalFilter(
                ...
                bool:(FloatSignal signal) ->
                {
                    float distance = Math.Abs(signal.value - note.judgementPosition);
            ...
            new InputGraphEdge(false, 1, pushInnerRespondTimeItem, false, true, true, null),
