...
class RespondHint : Element
{
    ...
    RespondHint(Vector2 respondPosition, float startTime, Node reference, ColorArgb color1, ColorArgb color2)
    {
        ...
        transformers[1] = new RespondHintHeartTransformer(this);
        
        // GorgeGraphics
        ImageAsset lineImage = (ImageAsset) Environment.GetAssetByName("image:Obsertor/FormAsset/RespondHint");
        ...
        ImageAsset heartImage = (ImageAsset) Environment.GetAssetByName("image:Obsertor/FormAsset/Heart");
